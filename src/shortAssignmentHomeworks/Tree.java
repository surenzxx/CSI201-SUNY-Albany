...
public class Tree {
	...
	public static void main(String[] args) {
		...
		int m = 8;
		int n = 5;
		drawTree(SCALE_MAX / 2, SCALE_MAX / 200, 90, 200, 0.015, m, n);
...
//		
//		
		//Khoa helped with understanding this conditional
